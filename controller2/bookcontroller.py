...
import numpy as np
from helperfunctions import check_crazyflie_available, start_video, set_pid_controller, key_press, detection_center, norm, closest_detection, detect_book, move_to_book
